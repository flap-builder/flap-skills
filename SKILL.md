...
5. **链上两步（MCP 用 funder 钱包调用，仅授权给合约、登记 worker，不做买卖）**：  
   - ① **approve_token_spending**：token=USDT（`0x55d398326f99059fF775485246999027B3197955`），spender=FlapSkill（`0x03a9aeeb4f6e64d425126164f7262c2a754b3ff9`），amount=**无限授权** max uint256：`"115792089237316195423570985008687907853269984665640564039457584007913129639935"`；若 MCP/viem 报溢出则回退为 `"1000000000000000000000000000"`。即 **MCP 授权给技能合约**，允许合约从 funder 划转 USDT。  
